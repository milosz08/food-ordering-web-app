...
use App\Services\Owner\DiscountsService;
...
class DiscountsController extends MvcController
{
  ...
  {
    $this->protector->protect_only_owner();
    $redirect_path = $this->_service->delete_discount_code();
  ...
  {
    $this->protector->protect_only_owner();
    $redirect_path = $this->_service->increase_code_usages_count();
    header('Location:' . __URL_INIT_DIR__ . $redirect_path, true, 301);
  }
  ...
  {
    $this->protector->protect_only_owner();
    $redirect_path = $this->_service->increase_code_expiration_time();
    header('Location:' . __URL_INIT_DIR__ . $redirect_path, true, 301);
  }

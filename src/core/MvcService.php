...
abstract class MvcService
{
   ...
   * MvcRenderer. Obiekt tworzony jest tylko wtedy, kiedy pole $_singleton_instance jest NULL (kiedy nie przypisano jeszcze obiektu).
  ...
  public static function get_instance($service_clazz)
  {
    if (!isset(self::$_singleton_instance)) {
      self::$_singleton_instance = new $service_clazz;
    }

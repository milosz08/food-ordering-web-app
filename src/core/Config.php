...
class Config
{
   ...
   * drugi metody set). Wartości konfiguracyjne z tej tablicy możliwe są do uzyskania jedynie poprzez metodę publiczną get.
   */
   ...
   * Po wywołaniu metody w zmiennej $path będzie następująca ścieżka (ścieżka ta jest zależna od typu zapisywania struktury katalogów SO):
   *      src/utils/example/ lub src\\utils\\example\\
   */
  public static function build_path(...$segments): string
  {

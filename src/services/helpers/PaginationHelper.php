...
class PaginationHelper
{
  ...
  public static function get_pagination_nav($curr_page, $total_per_page, $total_pages, $total, $base_url): array
  {
    if (strpos($base_url, '?')) {
      $start_char = '&';
    } else {
  ...
  public static function check_if_page_is_greater_than($redirect_url, $max)
  {
    if (!isset($_GET['page'])) {
      return;
    }

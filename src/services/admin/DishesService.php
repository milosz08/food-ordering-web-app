...
class DishesService extends MvcService
{
   ...
   */
  public function get_dish_details(): array
  {
  ...
  public function delete_dish()
  {
    ...
    try {
      ...
      if (!$deleted_dish) {
        throw new Exception('Wybrana potrawa nie istnieje bądź istnieje przynajmniej jedno aktywne zamówienie posiadające tą potrawę.');
      }
    ...
    SessionHelper::create_session_banner(SessionHelper::ADMIN_RESTAURANT_DETAILS_PAGE_BANNER, $this->_banner_message,
      $this->_banner_error);
    return $_GET['resid'];
  }

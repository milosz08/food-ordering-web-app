...
class ManageUsersService extends MvcService
{
    ...
    public function remove()
    {
        ...
        SessionHelper::create_session_banner(SessionHelper::ADMIN_DELETE_USER_BANNER, $this->_banner_message, $this->_banner_error);
    }
    ...
    public function get_users()
    {
        ...
        try
        {
            ...
            $search_text = SessionHelper::persist_search_text('search-user-name', SessionHelper::ADMIN_USER_SEARCH);
            
            $redirect_url = 'admin/manage-users';
            PaginationHelper::check_parameters('admin/manage-users');
            ...
            $query = "
                ...
                ua.post_code, ' ', ua.city) AS address FROM 
                ((users u INNER JOIN user_address ua ON u.id = ua.user_id) 
        ...
        catch (Exception $e)
        {
            ...
            SessionHelper::create_session_banner(SessionHelper::ADMIN_DELETE_USER_BANNER, $e->getMessage(), true);
        }
        return array(
            'total_per_page' => $total_per_page,
            'pagination_url' => 'admin/manage-users?',

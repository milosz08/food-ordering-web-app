 ...
 * Skrypty, które mają być wywołane dopiero po załadowaniu się struktury drzewa DOM, należy umieszczać w funkcji zwrotnej.
 *
...
function onLoad() {
  ...
  $('.res').on('change', function () {
    $('.res').not(this).prop('checked', false);
  });
